...
### 要件定義書（何を作るか）
- スマホ内の写真を活用した英語学習アプリ
- ユーザーは写真を選び、英語で気持ちを入力
- AI(Gemini/OpenAI) が添削や共感コメントを返す
- 入力内容と写真は Supabase に保存し履歴から閲覧可能

### ユースケース一覧 / 画面遷移図（ユーザーがどう使うか）

| ID  | アクター | ユースケース                            |
|----|------|------------------------------------ |
| UC1 | ユーザー | 写真を選んで英語表現を入力する              |
| UC2 | ユーザー | AI のフィードバックを確認する                |
| UC3 | ユーザー | 履歴から過去の学習内容を振り返る              |
